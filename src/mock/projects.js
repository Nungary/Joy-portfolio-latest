...
export const PROJECTS = [
  ...
  {
    imgSrc: 'https://i.postimg.cc/NGJQkWZ6/My-portfolio.png',
    ...
    repoLink: 'https://github.com/Nungary/Joy-portfolio-latest.git',
    sourceLink: 'https://joy-portfolio-latest.onrender.com/',
